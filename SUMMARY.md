...
* [Installation](installation/README.md)
  * [Skills needed to set up DIVOC](installation/skills-needed-to-set-up-divoc.md)
  * [Implementation Checklist](installation/implementation-checklist.md)
  * [Setting Up DIVOC](installation/setting-up-divoc/README.md)
    * [How to Install DIVOC](installation/setting-up-divoc/how-to-install-divoc.md)
    * [Backup & Restore: Postgres, Clickhouse, Kafka, & Redis](installation/setting-up-divoc/backup-and-restore-postgres-clickhouse-kafka-and-redis.md)
    * [Infrastructure Recovery](installation/setting-up-divoc/infrastructure-recovery.md)
    * [Server Hardening](installation/setting-up-divoc/server-hardening.md)
  * [DIVOC's Certification and Verification Component](installation/divocs-certification-and-verification-component/README.md)
    * [Generating Signed Key Pairs](installation/divocs-certification-and-verification-component/generating-signed-key-pairs.md)
    * [Configuring certificates](installation/divocs-certification-and-verification-component/configuring-certificates/README.md)
      * [Step 1: Create a certification generation request](installation/divocs-certification-and-verification-component/configuring-certificates/step-1-create-a-certification-generation-request.md)
      * [Step 2: Configure the QR code content](installation/divocs-certification-and-verification-component/configuring-certificates/step-2-configure-the-qr-code-content.md)
      * [Step 3: Configure the certificate template](installation/divocs-certification-and-verification-component/configuring-certificates/step-3-configure-the-certificate-template.md)
    * [How to set up the verification portal for implementation](installation/divocs-certification-and-verification-component/how-to-set-up-the-verification-portal-for-implementation.md)
    * [How to configure the update certificate API](installation/divocs-certification-and-verification-component/how-to-configure-the-update-certificate-api.md)
  * [Configuration Management Via ETCD](installation/configuration-management-via-etcd/README.md)
    * [Adding a New Vaccine and ICD-11 Mapping](installation/configuration-management-via-etcd/adding-a-new-vaccine-and-icd-11-mapping.md)
    * [PDF Template Change for Vaccine Certificates](installation/configuration-management-via-etcd/pdf-template-change-for-vaccine-certificates.md)
    * [EU Vaccine Configurations](installation/configuration-management-via-etcd/eu-vaccine-configurations.md)
    * [Payload Changes in the QR Code](installation/configuration-management-via-etcd/payload-changes-in-the-qr-code.md)
  * [Platform Policy Guidelines](installation/platform-policy-guidelines.md)
  * [Privacy Policy Recommendations](installation/privacy-policy-recommendations.md)
